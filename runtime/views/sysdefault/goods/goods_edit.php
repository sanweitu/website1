...
<?php $swfloadObject = new Swfupload();$swfloadObject->show($this->admin['admin_name'],$this->admin['admin_pwd']);?>
<script type="text/javascript" charset="UTF-8" src="/iwebshop/runtime/_systemjs/artTemplate/artTemplate.js"></script><script type="text/javascript" charset="UTF-8" src="/iwebshop/runtime/_systemjs/artTemplate/artTemplate-plugin.js"></script>
		...
		<form action="<?php echo IUrl::creatUrl("/goods/goods_update");?>" name="goodsForm" method="post">
			...
			<div id="table_box_1">
				<table class="form_table">
					...
					<tr>
						<th>商品名称：</th>
						<td>
							<input class="normal" name="name" type="text" value="" pattern="required" alt="商品名称不能为空" /><label class="red">*</label>
						</td>
					</tr>
					<tr>
						<th>商品链接：</th>
						<td>
							<textarea class="small" name="link"  pattern="required" alt="无效的商品链接" ></textarea><label class="red">url*</label>
						</td>
					</tr>
					<tr>
						<th>推荐理由：</th>
						<td>
						<textarea  class="small" name="reason" maxlength="140" pattern="required" alt="不能为空"></textarea><label class="red">字数限制：140</label>
							<!--<input class="normal" name="reason" type="text" value="" pattern="required"  alt="不能为空" /><label class="red">*</label>-->
						</td>
					</tr>
					<tr>
						<th>关键词：</th>
			...
			<div id="table_box_2" cellpadding="0" cellspacing="0" style="display:none">
				<table class="form_table">
					...
					<?php plugin::trigger("onSystemGoodsDetail");?>
					<tr>
						<th>产品描述：</th>
