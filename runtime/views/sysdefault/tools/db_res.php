...
<body>
	<div class="container">
		...
		<div id="admin_right">
			<?php $backupObj = new DBBackup;$resList = $backupObj->getList();?>
<div class="headbar">
...
<div class="content">
	<form action='<?php echo IUrl::creatUrl("/tools/backup_del");?>' method='post' name='resForm'>
		<table class="list_table">
			...
			<tbody>
				<?php foreach($resList['system'] as $key => $item){?>
				<tr>
					...
					<td>
						<a href="<?php echo IUrl::creatUrl("/tools/download/file/".$item['name']."");?>"><img class="operator" src="<?php echo $this->getWebSkinPath()."images/admin/icon_down.gif";?>" alt="下载" title="下载" /></a>
						<a href='javascript:void(0)' onclick="delModel({link:'<?php echo IUrl::creatUrl("/tools/backup_del/name/".$item['name']."");?>'});"><img class="operator" src="<?php echo $this->getWebSkinPath()."images/admin/icon_del.gif";?>" alt="删除" title="删除" /></a>
					</td>
				</tr>
				<?php }?>
			</tbody>
...
{
	art.dialog.open('<?php echo IUrl::creatUrl("/tools/upload_sql");?>',{
		id:'uploadSql',
		title:'上传SQL文件',
...
{
	window.location.href='<?php echo IUrl::creatUrl("/tools/db_bak");?>';
}
