...
<div class="position"> <span>全部结果：</span> <a href="javascript:void(0)"><?php echo $this->word;?></a> </div>
<div class="wrapper clearfix container_2">
	...
	<div class="search_list main f_r">
		<strong class="result">"<span class="red"><?php echo $this->word;?></span>" 搜索结果</strong>
