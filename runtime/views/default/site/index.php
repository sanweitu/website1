...
<head>
	...
	<script type="text/javascript" charset="UTF-8" src="/other/iwebshop/runtime/_systemjs/jquery/jquery-1.12.4.min.js"></script>
	<script type="text/javascript" charset="UTF-8" src="/other/iwebshop/runtime/_systemjs/form/form.js"></script>
	<script type="text/javascript" charset="UTF-8" src="/other/iwebshop/runtime/_systemjs/autovalidate/validate.js"></script><link rel="stylesheet" type="text/css" href="/other/iwebshop/runtime/_systemjs/autovalidate/style.css" />
	<script type="text/javascript" charset="UTF-8" src="/other/iwebshop/runtime/_systemjs/artdialog/artDialog.js"></script><script type="text/javascript" charset="UTF-8" src="/other/iwebshop/runtime/_systemjs/artdialog/plugins/iframeTools.js"></script><link rel="stylesheet" type="text/css" href="/other/iwebshop/runtime/_systemjs/artdialog/skins/aero.css" />
	<script type="text/javascript" charset="UTF-8" src="/other/iwebshop/runtime/_systemjs/artTemplate/artTemplate.js"></script><script type="text/javascript" charset="UTF-8" src="/other/iwebshop/runtime/_systemjs/artTemplate/artTemplate-plugin.js"></script>
...
<div class="container">
	<div class="header">
		...
		<ul class="shortcut">
			<li class="first"><a href="<?php echo IUrl::creatUrl("/ucenter/index");?>">我的账户1</a></li>
			<li><a href="<?php echo IUrl::creatUrl("/ucenter/order");?>">我的订单1</a></li>
			<li><a href="<?php echo IUrl::creatUrl("/simple/seller");?>">申请开店1</a></li>
			<li><a href="<?php echo IUrl::creatUrl("/seller/index");?>">商家管理1</a></li>
	...
	<script type="text/javascript" charset="UTF-8" src="/other/iwebshop/runtime/_systemjs/jquerySlider/jquery.bxslider.min.js"></script><link rel="stylesheet" type="text/css" href="/other/iwebshop/runtime/_systemjs/jquerySlider/jquery.bxslider.css" />
