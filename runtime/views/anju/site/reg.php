		 ...
		 <div class="registration_left">
			 ...
			 <!-- Form -->
				<form action='<?php echo IUrl::creatUrl("/simple/reg_act");?>' method='post'>
					...
					<div>
						<label>
							<input placeholder="用户名：" name='username' type="text" tabindex="2" pattern="^[\w\u0391-\uFFE5]{2,20}$" alt="填写2-20个字符，可以为字数，数字下划线和中文" /><label>请填写用户名，格式为2-20个字符，可以为字数，数字下划线和中文</label>
						</label>
					</div>					
										
					<div>
						<label>
							<input placeholder="password" type="password" tabindex="4" name='password' pattern="^\S{6,32}$" bind='repassword' alt='填写6-32个字符' /><label>填写登录密码，6-32个字符</label>
						</label>
					</div>						
					<div>
						<label>
